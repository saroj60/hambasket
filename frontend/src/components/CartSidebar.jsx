        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '1.5rem' }}>
          ...
          {step === 'success' && (
            <div style={{ padding: '2rem', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%' }}>
              ...
              <h3 style={{ fontSize: '1.5rem', fontWeight: '800', color: 'var(--primary)', marginBottom: '0.5rem' }}>Almost There!</h3>
              <p style={{ color: 'var(--text-muted)', marginBottom: '1rem', lineHeight: '1.5' }}>
                Your order ID is generated.<br />
                <span style={{ fontWeight: '700', color: '#ef4444' }}>Final Step:</span> You MUST send the message on WhatsApp to confirm your order.
              </p>
