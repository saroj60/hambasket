...
const CATEGORY_METADATA = {
    ...
    "Bakery and Biscuits": { label: "Bakery & Biscuits", img: "/assets/categories/bakery_biscuits.png" },
    "Snacks & Beverages": { label: "Snacks & Beverages", img: "/assets/categories/snacks_beverages.jpg" },
    "Tea and coffee": { label: "Tea & Coffee", img: "/assets/categories/tea_coffee.png" },
    "Organic and Dry Fruits": { label: "Organic & Dry Fruits", img: "/assets/categories/organic_dryfruits.png" },
    "Breakfast and sauce": { label: "Breakfast & Sauces", img: "/assets/categories/breakfast_sauces.jpg" },
